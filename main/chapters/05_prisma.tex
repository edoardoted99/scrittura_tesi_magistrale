...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{pictures/cap5/1_load_ds.png}
    \caption{L'utente può caricare un dataset di dati testuali e scegliere quale modello di embedding denso utilizzare per la fase di pre-encoding. I dati testuali salvati nel database MySQL di PRISMA con il relativo vettore $\mathbf{x}$ di embedding una volta generato.}
    \label{fig:prisma_home}
\end{figure}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{pictures/cap5/2_prepare_experiment.png}
    \caption{Una volta terminata la generazione del dataset di embedding, l'utente può selezionarlo, configurare gli iper parametri dell'addestramento dello Sparse Autoencoder e monitorarne il progresso in tempo reale.}
    \label{fig:prisma_home}
\end{figure}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{pictures/cap5/training_2.png}
    \caption{View che mostra i risultati dell'addestramento e la matrice dello spazio latente $H$ con attivazioni sparse.}
    \label{fig:prisma_home}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{pictures/cap5/8_vector_sparse_unsorted.png}
        \caption{Rappresentazione sparsa delle attivazioni associate ad un singolo documento in input. Le attivazioni corrispondono a concetti.}
        \label{fig:vector_unsorted}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{\textwidth}
        \centering
        \includegraphics[width=\textwidth]{pictures/cap5/6_vector_sparse_sorted.png}
        \caption{Vettore riordinato}
        \label{fig:vector_sorted}
    \end{subfigure}
    \caption{Rappresentazione latente delle feature attivate da un documento: confronto tra vettore originale e riordinato per valori decrescenti.}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{pictures/cap5/9_fam_1.png}
    \caption{Grafo delle feature.}
    \label{fig:feature_graph}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{pictures/cap5/10_fam_2.png}
    \caption{Le feature si organizzano in grappoli che sono le feature families.}
    \label{fig:feature_families_clusters}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{pictures/cap5/11_feature_fam_3.png}
    \caption{In blu sono evidenziate feature che fanno da ponte tra più feature families.}
    \label{fig:feature_bridges}
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{pictures/cap5/12_featur_familis_children.png}
    \caption{Feature figlie legate al loro genitore (cryptography).}
    \label{fig:feature_children_cryptography}
\end{figure}
