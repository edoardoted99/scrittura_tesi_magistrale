...
\begin{figure}[htbp]
    ...
    \begin{tikzpicture}[scale=1.2]
        ...
        % Frecce tratteggiate verso l'ideale (ortogonali)
        % Dalle reti neurali: prima su, poi a destra
        \draw[->, dashed, thick, green!60!black] (4,1.6) -- (4,3.1);
        % Dalle leggi fisiche: prima a destra, poi su
        \draw[->, dashed, thick, green!60!black] (2.2,3.1) -- (3.8,3.1) -- (3.8,3.3);
