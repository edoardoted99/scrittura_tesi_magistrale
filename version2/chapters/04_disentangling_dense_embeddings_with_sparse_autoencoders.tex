\chapter{Disentangling Dense Embeddings \\with Sparse Autoencoders}
...
Questa mancanza di interpretabilità rappresenta un limite rilevante, in particolare
...
In questo capitolo analizziamo il metodo proposto nel lavoro
