...
\subsection{Generaizone di Embeddings tramite RNN}
...
\subsection{RNN Bidirezionali (Bi-RNN)}
...
\subsection{Il problema del Gradiente Svanente}
...
\subsection{Modularità ed Embeddings}
...
\subsection{Il limite del \textit{bottleneck} informativo}
...
\subsection{Soluzione al bottleneck: Meccanismo dell'attenzione}
...
\subsection{Verso i Transformer}
